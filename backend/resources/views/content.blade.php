...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="index.html">داروخانه</a>
    ...
    <div class="container">
        <h2 class="mt-5">محصولات ما</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">محصول 1</h5>
                        <p class="card-text">توضیحات محصول 1.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">محصول 2</h5>
                        <p class="card-text">توضیحات محصول 2.</p>
                        <a href="#" class="btn btn-primary">مشاهده جزئیات</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">محصول 3</h5>
                        <p class="card-text">توضیحات محصول 3.</p>
                        <a href="#" class="btn btn-primary">مشاهده جزئیات</a>
                    </div>
                </div>
            </div>
