...
<div class="container">
    ...
    <form action="{{ route('inventory_update', ['invent_id' => $inventor->invent_id]) }}" method="POST">
        @csrf
        ...
        {{-- <div class="form-group">
            ...
            <input type="number" name="quantity" id="quantity" class="form-control" 
                   value="{{ old('quantity', $medication->quantity) }}" required>
        </div>
        
        <div class="form-group">
            <label for="unit_price">قیمت فی قطی </label>
            <input type="number" name="unit_price" id="unit_price" class="form-control" 
                   value="{{ old('unit_price', $medication->unit_price) }}"> --}}
        {{-- </div> --}}
