...
<div class="container mt-4">
    ...
    <div class="table-responsive">
            ...
            <tbody>
                @foreach($medication as $medi)
                    ...
                    <td>{{ $medi->updated_at }}</td>
                        ...
                        <td>
                            {{-- <a href="{{ route('medications.edit', $medi->medication_id) }}" class="btn btn-sm btn-warning">ویرایش</a>

                            <form action="{{ route('medications.destroy', $medi->medication_id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $medication->links('vendor.pagination.bootstrap-5') }}
        </div>
